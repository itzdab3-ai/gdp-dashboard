...
# العنوان مع الحقوق gx1gx1 بدلاً من الجمجمة
...
# خيارات نوع العملية معربة وحذف خيار رقم 3
option = st.selectbox("اختر نوع البلاغ:", ["-- اختر --", "سوف يضاف خيارات اخرى", "بلاغ إنستجرام لايت"])
